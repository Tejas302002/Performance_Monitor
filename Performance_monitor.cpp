...
// Class for CPU
class CPU : public Performance_Monitor
{
private:
...
public:
    ...
    double GetCpuSpeedInGhz() const {
        ...
        cpu_speed = floor(cpu_speed * 10) / 10.0;
        return cpu_speed;
    }
    //For calculating CPU Uptime in days:hours:minutes:seconds
    ...
    void StartMonitoring() {
        ...
        try {
            ...
            cout << "An exception occurred while monitoring CPU: " << e.what() << endl;
        }
    }
    //printing the Usage , uptime and speed
...
// Memory class
class MemoryUsage : public Performance_Monitor
{
...
public:
    MemoryUsage() {
        try {
            ...
            cout << "An exception occurred while initializing memory usage: " << e.what() << endl;
        }
    }
...
//claass for WIFI
class WIFI : public Performance_Monitor
{
public:
    //for calculating the WIFI send speed
